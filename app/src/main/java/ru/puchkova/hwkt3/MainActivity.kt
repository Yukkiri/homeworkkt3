...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Дефолтное состояние менеджера - вертиакльный скролл
        postList.layoutManager = LinearLayoutManager(this)

        // Это не нужно, пермишены на интернет юзер дает при установке. В любом случае еще нужно обработать ответ юзера в
        // Методе onRequestPermissionsResult
